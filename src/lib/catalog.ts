...
export type HeroSlide = {
  ...
  /** Main artwork, then the two cards that float over it. */
...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    headline: ["Cakes and flowers,", "made the day", "they reach the door."],
    body: "We do two things. We bake, and we buy stems at the morning market. Everything on this site is put together after you order it — which is the whole reason it tastes and looks the way it does.",
    primary: { label: "Shop cakes", href: "/shop?category=cakes" },
    secondary: { label: "Shop flowers", href: "/shop?category=flowers" },
    art: ["anniversary-gold-set", "hundred-red-roses", "red-velvet-crown"],
    badge: ["Delivering tonight", "Midnight slot · 214 orders out"],
  },
  {
    eyebrow: "Midnight delivery · cut-off 8 PM",
    headline: ["Land it at", "11:52 PM,", "before they expect it."],
    body: "Our riders carry birthday orders on a separate late route. Median drop time last month was eight minutes before midnight, and the cake is boxed cold from the kitchen at 9.",
    primary: { label: "Shop birthday cakes", href: "/shop?occasion=birthday" },
    secondary: { label: "See combos", href: "/shop?category=combos" },
    art: ["midnight-truffle-cake", "roses-and-truffle-combo", "butterscotch-praline-cake"],
    badge: ["Tonight's late route", "Cut-off 8:00 PM"],
  },
  {
    eyebrow: "Cut at 5 AM · wrapped by 9",
    headline: ["A hundred roses,", "counted twice,", "tied once."],
    body: "Stems are graded by head size before they are wrapped, and every large bunch is counted by two people. If a variety is short on the day, we call you rather than quietly substituting it.",
    primary: { label: "Shop flowers", href: "/shop?category=flowers" },
    secondary: { label: "Anniversary gifts", href: "/shop?occasion=anniversary" },
    art: ["hundred-red-roses", "emerald-bridal-bouquet", "orchid-and-rose-basket"],
    badge: ["At the market now", "Roses graded A · 4,100 stems"],
  },
];
